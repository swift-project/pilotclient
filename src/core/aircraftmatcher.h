...
namespace swift::core
{
    ...
    class SWIFT_CORE_EXPORT CAircraftMatcher : public QObject, public swift::misc::simulation::IAircraftModelSetProvider
    {
        Q_OBJECT
    ...
    public:
        ...
        getClosestMatch(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                        swift::misc::simulation::MatchingLog whatToLog, swift::misc::CStatusMessageList *log,
                        bool useMatchingScript) const;

        //! Return an valid airline ICAO code
        //! \threadsafe
        static swift::misc::aviation::CAirlineIcaoCode
        failoverValidAirlineIcaoDesignator(const swift::misc::aviation::CCallsign &callsign, const QString &primaryIcao,
                                           const QString &secondaryIcao, bool airlineFromCallsign,
                                           const QString &airlineName, const QString &airlineTelephony,
                                           bool useWebServices, swift::misc::CStatusMessageList *log = nullptr);
        ...
        static swift::misc::aviation::CAirlineIcaoCode failoverValidAirlineIcaoDesignator(
            const swift::misc::aviation::CCallsign &callsign, const QString &primaryIcao, const QString &secondaryIcao,
            bool airlineFromCallsign, const QString &airlineName, const QString &airlineTelephony,
            const swift::misc::simulation::CAircraftModelList &models, swift::misc::CStatusMessageList *log = nullptr);
        ...
        reverseLookupScript(const swift::misc::simulation::CAircraftModel &inModel,
        ...
        //! \threadsafe
        static swift::misc::simulation::MatchingScriptReturnValues
        matchingStageScript(const swift::misc::simulation::CAircraftModel &inModel,
        ...
        //! \threadsafe
        static swift::misc::simulation::MatchingScriptReturnValues
        matchingScript(const QString &js, const swift::misc::simulation::CAircraftModel &inModel,
                       const swift::misc::simulation::CAircraftModel &matchedModel,
                       const swift::misc::simulation::CAircraftMatcherSetup &setup,
                       const swift::misc::simulation::CAircraftModelList &modelSet,
                       swift::misc::simulation::MatchingScript ms, swift::misc::CStatusMessageList *log);
        ...
        static swift::misc::simulation::CAircraftModel reverseLookupModel(
            ...
            const swift::misc::aviation::CAirlineIcaoCode &networkAirlineIcao, const QString &networkLiveryInfo,
            const QString &networkModelString, const swift::misc::simulation::CAircraftMatcherSetup &setup,
            const swift::misc::simulation::CAircraftModelList &modelSet,
            swift::misc::simulation::CAircraftModel::ModelType type, swift::misc::CStatusMessageList *log);
        ...
        //! \remark NOT running matching script
        static swift::misc::simulation::CAircraftModel reverseLookupModel(
            const swift::misc::simulation::CAircraftModel &modelToLookup, const QString &networkLiveryInfo,
            const swift::misc::simulation::CAircraftMatcherSetup &setup,
            const swift::misc::simulation::CAircraftModelList &modelSet, swift::misc::CStatusMessageList *log);
        ...
        reverseLookupModelStringInDB(const QString &modelString, const swift::misc::aviation::CCallsign &callsign,
        ...
        //! \ingroup reverselookup
        static swift::misc::simulation::CAircraftModel
        reverseLookupModelStringInSet(const QString &modelString, const swift::misc::aviation::CCallsign &callsign,
                                      const swift::misc::simulation::CAircraftModelList &modelSet, bool useNonDbEntries,
                                      swift::misc::CStatusMessageList *log);
        ...
        //! \ingroup reverselookup
        static swift::misc::simulation::CAircraftModel
        reverseLookupModelId(int id, const swift::misc::aviation::CCallsign &callsign,
                             swift::misc::CStatusMessageList *log);

        //! Try to find the DB corresponding ICAO code
        //! \threadsafe
        //! \ingroup reverselookup
        static swift::misc::aviation::CAircraftIcaoCode
        reverseLookupAircraftIcao(const swift::misc::aviation::CAircraftIcaoCode &icaoDesignator,
        ...
        //! \ingroup reverselookup
        static swift::misc::aviation::CAircraftIcaoCode
        reverseLookupAircraftIcaoId(int id, const swift::misc::aviation::CCallsign &logCallsign,
                                    swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \ingroup reverselookup
        static swift::misc::aviation::CAirlineIcaoCode
        reverseLookupAirlineIcao(const swift::misc::aviation::CAirlineIcaoCode &icaoPattern,
                                 const swift::misc::aviation::CCallsign &callsign = {},
                                 swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        //! \ingroup reverselookup
        static swift::misc::aviation::CLivery
        reverseLookupStandardLivery(const swift::misc::aviation::CAirlineIcaoCode &airline,
                                    const swift::misc::aviation::CCallsign &callsign,
                                    swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        //! \ingroup reverselookup
        static swift::misc::aviation::CLivery reverseLookupLiveryId(int id,
                                                                    const swift::misc::aviation::CCallsign &logCallsign,
                                                                    swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        //! \ingroup reverselookup
        static int reverseLookupByIds(const swift::misc::simulation::DBTripleIds &ids,
        ...
        //! \threadsafe
        //! \ingroup reverselookup
        static QString reverseLookupAirlineName(const QString &candidate,
                                                const swift::misc::aviation::CCallsign &callsign = {},
                                                swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        //! \ingroup reverselookup
        static QString reverseLookupTelephonyDesignator(const QString &candidate,
                                                        const swift::misc::aviation::CCallsign &callsign = {},
                                                        swift::misc::CStatusMessageList *log = nullptr);

        //! Is this aircraft designator known?
        //! \threadsafe
        static bool isKnownAircraftDesignator(const QString &candidate,
                                              const swift::misc::aviation::CCallsign &callsign = {},
                                              swift::misc::CStatusMessageList *log = nullptr);

        //! Is this aircraft designator known?
        //! \threadsafe
        static bool isKnownModelString(const QString &candidate, const swift::misc::aviation::CCallsign &callsign = {},
                                       swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        static swift::misc::aviation::CAircraftIcaoCode
        searchAmongAirlineAircraft(const QString &icaoString, const swift::misc::aviation::CAirlineIcaoCode &airline,
                                   const swift::misc::aviation::CCallsign &callsign = {},
                                   swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        static swift::misc::aviation::CAirlineIcaoCode
        callsignToAirline(const swift::misc::aviation::CCallsign &callsign,
                          swift::misc::CStatusMessageList *log = nullptr);
        ...
        int setModelSet(const swift::misc::simulation::CAircraftModelList &models,
                        const swift::misc::simulation::CSimulatorInfo &simulator, bool forced);
        ...
        void evaluateStatisticsEntry(const QString &sessionId, const swift::misc::aviation::CCallsign &callsign,
    ...
    private:
        ...
        getClosestMatchStepwiseReduceImplementation(const swift::misc::simulation::CAircraftModelList &modelSet,
                                                    const swift::misc::simulation::CAircraftMatcherSetup &setup,
                                                    const swift::misc::simulation::CCategoryMatcher &categoryMatcher,
        ...
        static swift::misc::simulation::CAircraftModelList
        getClosestMatchScoreImplementation(const swift::misc::simulation::CAircraftModelList &modelSet,
                                           const swift::misc::simulation::CAircraftMatcherSetup &setup,
                                           const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                           int &maxScore, swift::misc::simulation::MatchingLog whatToLog,
                                           swift::misc::CStatusMessageList *log = nullptr);

        //! Get combined type default model, i.e. get a default model under consideration of the combined code such as
        //! "L2J" \see swift::misc::simulation::CSimulatedAircraft::getAircraftIcaoCombinedType \remark in any case a
        //! (default) model is returned
        static swift::misc::simulation::CAircraftModel
        getCombinedTypeDefaultModel(const swift::misc::simulation::CAircraftModelList &modelSet,
                                    const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                    const swift::misc::simulation::CAircraftModel &defaultModel,
                                    swift::misc::simulation::MatchingLog whatToLog,
                                    swift::misc::CStatusMessageList *log = nullptr);
        ...
        //! \threadsafe
        static swift::misc::simulation::CAircraftModel
        matchByExactModelString(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
        ...
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByIcaoData(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                   const swift::misc::simulation::CAircraftModelList &models,
                                   const swift::misc::simulation::CAircraftMatcherSetup &setup, bool &reduced,
                                   swift::misc::CStatusMessageList *log);

        //! Find model by aircraft family
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByFamily(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                 bool allowPseudoFamily, const swift::misc::simulation::CAircraftModelList &inList,
                                 bool &reduced, QString &usedFamily, swift::misc::CStatusMessageList *log);
        ...
        ifPossibleReduceByFamily(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                 ...
                                 const swift::misc::simulation::CAircraftModelList &inList, const QString &hint,
                                 bool &reduced, swift::misc::CStatusMessageList *log);

        //! Search for exact livery and aircraft ICAO code
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByLiveryAndAircraftIcaoCode(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                                    const swift::misc::simulation::CAircraftModelList &inList,
                                                    bool &reduced, swift::misc::CStatusMessageList *log);

        //! Reduce by manufacturer
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByManufacturer(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                       const swift::misc::simulation::CAircraftModelList &inList, const QString &info,
                                       bool &reduced, swift::misc::CStatusMessageList *log);

        //! Reduce by manufacturer
        //! \threadsafe
        static swift::misc::aviation::CAircraftIcaoCodeList ifPossibleReduceAircraftIcaoByManufacturer(
            const swift::misc::aviation::CAircraftIcaoCode &icaoCode,
            const swift::misc::aviation::CAircraftIcaoCodeList &inList, const QString &info, bool &reduced,
            const swift::misc::aviation::CCallsign &logCallsign, swift::misc::CStatusMessageList *log);

        //! Reduce by aircraft ICAO
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByAircraft(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                   const swift::misc::simulation::CAircraftModelList &inList, const QString &info,
                                   bool &reduced, swift::misc::CStatusMessageList *log);
        ...
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByAircraftOrFamily(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                           bool allowPseudoFamily,
                                           const swift::misc::simulation::CAircraftModelList &inList,
                                           const swift::misc::simulation::CAircraftMatcherSetup &setup,
                                           const QString &info, bool &reduced, swift::misc::CStatusMessageList *log);

        //! Reduce by airline ICAO
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByAirline(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                  const swift::misc::simulation::CAircraftModelList &inList,
                                  const swift::misc::simulation::CAircraftMatcherSetup &setup, const QString &info,
                                  bool &reduced, swift::misc::CStatusMessageList *log);
        ...
        static swift::misc::simulation::CAircraftModelList ifPossibleReduceModelsByAirlineNameTelephonyDesignator(
            const swift::misc::aviation::CCallsign &cs, const QString &airlineName, const QString &telephony,
            const swift::misc::simulation::CAircraftModelList &inList, const QString &info, bool &reduced,
            swift::misc::CStatusMessageList *log);

        //! Installed models by combined code (ie L2J, L1P, ...)
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByCombinedType(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                       const swift::misc::simulation::CAircraftModelList &inList,
                                       const swift::misc::simulation::CAircraftMatcherSetup &setup, bool &reduced,
                                       swift::misc::CStatusMessageList *log);
        ...
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByMilitaryFlag(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                       const swift::misc::simulation::CAircraftModelList &inList, bool &reduced,
                                       swift::misc::CStatusMessageList *log);

        //! By VTOL flag
        //! \threadsafe
        static swift::misc::simulation::CAircraftModelList
        ifPossibleReduceByVTOLFlag(const swift::misc::simulation::CSimulatedAircraft &remoteAircraft,
                                   const swift::misc::simulation::CAircraftModelList &inList, bool &reduced,
                                   swift::misc::CStatusMessageList *log);
        ...
        //! \threadsafe
        static swift::misc::aviation::CAirlineIcaoCode
        stringToAirlineIcaoObject(const swift::misc::aviation::CCallsign &cs, const QString &designator,
                                  const QString &airlineName, const QString &airlineTelephony, bool useSwiftDbData,
                                  swift::misc::CStatusMessageList *log);
