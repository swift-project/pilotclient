...
namespace swift::core::db
{
    ...
    private:
        swift::misc::CData<swift::core::data::TDbAircraftIcaoCache> m_aircraftIcaoCache { this, &CIcaoDataReader::aircraftIcaoCacheChanged };
        swift::misc::CData<swift::core::data::TDbAirlineIcaoCache> m_airlineIcaoCache { this, &CIcaoDataReader::airlineIcaoCacheChanged };
        swift::misc::CData<swift::core::data::TDbCountryCache> m_countryCache { this, &CIcaoDataReader::countryCacheChanged };
        swift::misc::CData<swift::core::data::TDbAircraftCategoryCache> m_categoryCache { this, &CIcaoDataReader::aircraftCategoryCacheChanged };
        ...
        swift::misc::CData<swift::core::data::TDbIcaoReaderBaseUrl> m_readerUrlCache { this, &CIcaoDataReader::baseUrlCacheChanged };
