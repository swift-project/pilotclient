...
{
    CDbOwnModelSetDialog::CDbOwnModelSetDialog(QWidget *parent) : QDialog(parent), ui(new Ui::CDbOwnModelSetDialog)
    {
        ui->setupUi(this);
    ...
    const CDbOwnModelSetComponent *CDbOwnModelSetDialog::modelSetComponent() const { return ui->comp_OwnModelSet; }

    CDbOwnModelSetComponent *CDbOwnModelSetDialog::modelSetComponent() { return ui->comp_OwnModelSet; }
