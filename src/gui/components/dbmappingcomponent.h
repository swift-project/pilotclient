...
namespace swift::gui
{
    ...
    namespace components
    {
         ...
         * Mapping component
         */
        class SWIFT_GUI_EXPORT CDbMappingComponent :
        ...
        public:
            ...
            //! \name Models from swift::gui::components::CDbStashComponent
            //! @{
            //! Stashed models
            ...
            //! \name Own models from swift::gui::components::CDbOwnModelsComponent
            //! @{
            //! Own models
...
#endif // SWIFT_GUI_COMPONENTS_DBMAPPINGCOMPONENT_H
