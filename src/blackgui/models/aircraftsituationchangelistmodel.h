...
namespace BlackGui::Models
{
    ...
    class BLACKGUI_EXPORT CAircraftSituationChangeListModel : public CListModelTimestampWithOffsetObjects<swift::misc::aviation::CAircraftSituationChangeList, true>
    {
        Q_OBJECT
