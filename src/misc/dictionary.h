...
namespace swift::misc
{
    ...
    public:
        ...
        {
            return findKeyBy(swift::misc::predicates::MemberEqual(pairs...));
        }
        ...
        {
            return findValueBy(swift::misc::predicates::MemberEqual(pairs...));
        }
        ...
        {
            return containsByKey(swift::misc::predicates::MemberEqual(membFunc, returnValue));
        }
        ...
        {
            return containsByValue(swift::misc::predicates::MemberEqual(membFunc, returnValue));
        }
        ...
        {
            removeByKeyIf(swift::misc::predicates::MemberEqual(membFunc, returnValue));
        }
        ...
        {
            removeByValueIf(swift::misc::predicates::MemberEqual(membFunc, returnValue));
        }
