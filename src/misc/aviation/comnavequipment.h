...
#ifndef SWIFT_MISC_AVIATION_COMNAVEQUIPMENT_H
#define SWIFT_MISC_AVIATION_COMNAVEQUIPMENT_H

#include "misc/swiftmiscexport.h"
#include "misc/valueobject.h"

SWIFT_DECLARE_VALUEOBJECT_MIXINS(swift::misc::aviation, CComNavEquipment)

namespace swift::misc::aviation
{
    //! ICAO flightplan field 10a
    class SWIFT_MISC_EXPORT CComNavEquipment : public swift::misc::CValueObject<CComNavEquipment>
    {
    public:
    ...
    private:
        ...
        SWIFT_METACLASS(
            ...
            SWIFT_METAMEMBER(cpdlcSatcomEquipment));
    };
}

Q_DECLARE_METATYPE(swift::misc::aviation::CComNavEquipment)

#endif // SWIFT_MISC_AVIATION_COMNAVEQUIPMENT_H
