...
namespace swift::misc::simulation
{
    ...
    class SWIFT_MISC_EXPORT ISimulationEnvironmentProvider : public IProvider
    {
    public:
    ...
    class SWIFT_MISC_EXPORT CSimulationEnvironmentAware : public IProviderAware<ISimulationEnvironmentProvider>
    {
        virtual void anchor();
