...
{
    //! The network values
    class SWIFT_MISC_EXPORT MSInOutValues : public QObject
    {
        Q_OBJECT
    ...
    public:
        ...
        MSInOutValues(const swift::misc::aviation::CCallsign &cs,
                      const swift::misc::aviation::CAircraftIcaoCode &aircraftIcao,
                      const swift::misc::aviation::CLivery &livery);
    ...
    class SWIFT_MISC_EXPORT MSModelSet : public QObject
    {
        Q_OBJECT
...
#endif // SWIFT_MISC_SIMULATION_MATCHINGSCRIPT_H
