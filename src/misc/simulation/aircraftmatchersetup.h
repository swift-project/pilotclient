...
{
    //! Matcher settings
    class SWIFT_MISC_EXPORT CAircraftMatcherSetup : public CValueObject<CAircraftMatcherSetup>
    {
    public:
        //! Matching algorithm
...
Q_DECLARE_METATYPE(swift::misc::simulation::CAircraftMatcherSetup::MatchingMode)
Q_DECLARE_METATYPE(swift::misc::simulation::CAircraftMatcherSetup::MatchingModeFlag)
Q_DECLARE_METATYPE(swift::misc::simulation::CAircraftMatcherSetup::ForceMode)
Q_DECLARE_METATYPE(swift::misc::simulation::CAircraftMatcherSetup::ForceModeFlag)
