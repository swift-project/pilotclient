...
namespace swift::misc
{
    ...
    namespace simulation
    {
        ...
        public:
            ...
            CSimulatedAircraft getOwnAircraft() const override;

            //! \copydoc IOwnAircraftProvider::getOwnCallsign
            aviation::CCallsign getOwnCallsign() const override;

            //! \copydoc IOwnAircraftProvider::getOwnComSystem
            aviation::CComSystem getOwnComSystem(aviation::CComSystem::ComUnit unit) const override;

            //! \copydoc IOwnAircraftProvider::getOwnTransponder
            aviation::CTransponder getOwnTransponder() const override;
