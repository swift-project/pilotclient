...
namespace swift::misc
{
    namespace private_ns
    {
         ...
         */
        class SWIFT_MISC_EXPORT CDataPageQueue : public QObject
        {
            Q_OBJECT
     ...
     * \threadsafe
     */
    class SWIFT_MISC_EXPORT CDataCacheRevision
    {
    public:
     ...
     */
    class SWIFT_MISC_EXPORT CDataCacheSerializer : public swift::misc::CContinuousWorker
    {
        Q_OBJECT
    ...
    private:
        ...
        swift::misc::CValueCachePacket m_deferredChanges;
    };
     ...
     */
    class SWIFT_MISC_EXPORT CDataCache : public swift::misc::CValueCache
    {
        Q_OBJECT
     ...
     * \tparam Trait A subclass of swift::misc::TDataTrait that identifies the value's key and other metadata.
     */
    ...
    public:
        ...
        //! \copydoc swift::misc::CCached::set
        ...
        //! \copydoc swift::misc::CCached::setProperty
     ...
     */
    template <typename Trait>
    class CDataReadOnly : public swift::misc::CData<Trait>
    {
    public:
