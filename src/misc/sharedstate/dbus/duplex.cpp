...
namespace swift::misc::shared_state::dbus
{
    ...
    QFuture<CVariant> IDuplex::receiveRequest(const QString &channel, const swift::misc::CVariant &param)
    {
        const auto token = getToken();
    ...
    void IDuplex::reply(const swift::misc::CVariant &param, quint32 token)
    {
