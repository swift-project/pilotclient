...
namespace swift::misc
{
    namespace private_ns
    {
        ...
        SWIFT_MISC_EXPORT SWIFT_NO_INLINE QVector<int> findIndices(int size, const std::function<bool(int)> &predicate);
...
#    pragma GCC diagnostic pop
        ...
        //! \copydoc swift::misc::CRangeBase::findBy
        template <class Predicate>
        CSequence findBy(Predicate p) const
        {
            QVector<T> found;
            for (int i : private_ns::findIndices(size(), [&p, this](int i) { return p((*this)[i]); }))
            {
        ...
        {
            return applyIf(swift::misc::predicates::MemberEqual(key1, value1), newValues, skipEqualValues);
        }
        ...
        {
            erase(swift::misc::removeIfIn(begin(), end(), other.begin(), other.end()), end());
        }
        ...
        {
            return replaceIf(swift::misc::predicates::MemberEqual(key1, value1), replacement);
        }
        ...
        {
            sort(swift::misc::predicates::MemberLess(key1, keys...));
        }
        ...
        {
            return sorted(swift::misc::predicates::MemberLess(key1, keys...));
        }
        ...
        {
            partiallySort(n, swift::misc::predicates::MemberLess(key1, keys...));
        }
        ...
        {
            return partiallySorted(n, swift::misc::predicates::MemberLess(key1, keys...));
        }
