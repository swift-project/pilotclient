...
namespace swift::misc
{
     ...
     */
    class SWIFT_MISC_EXPORT CSettingsCache : public swift::misc::CValueCache
    {
        Q_OBJECT
     ...
     * \tparam Trait A subclass of swift::misc::TSettingTrait that identifies the value's key and other metadata.
     */
    template <typename Trait>
    class CSetting : public swift::misc::CCached<typename Trait::type>
    {
    public:
        //! Constructor.
     ...
     */
    template <typename Trait>
    class CSettingReadOnly : public swift::misc::CSetting<Trait>
    {
    public:
