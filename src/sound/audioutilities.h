...
namespace swift::sound
{
    ...
    SWIFT_SOUND_EXPORT QAudioDevice getLowestLatencyDevice(const swift::misc::audio::CAudioDeviceInfo &device,
                                                           QAudioFormat &format);
    SWIFT_SOUND_EXPORT QAudioDevice getHighestCompatibleOutputDevice(const swift::misc::audio::CAudioDeviceInfo &device,
                                                                     QAudioFormat &format);
