...
namespace MiscTest
{
    ...
    void CTestAviation::testWakeTurbulenceCategories()
    {
        ...
        QVERIFY(catLight1.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::LIGHT));
        QVERIFY(catLight2.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::LIGHT));
        QVERIFY(catLight3.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::LIGHT));
        QCOMPARE(catLight1.toQString(), "L");

        QVERIFY(catMedium1.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::MEDIUM));
        QVERIFY(catMedium2.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::MEDIUM));
        QVERIFY(catMedium3.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::MEDIUM));
        QCOMPARE(catMedium1.toQString(), "M");

        QVERIFY(catHeavy1.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::HEAVY));
        QVERIFY(catHeavy2.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::HEAVY));
        QVERIFY(catHeavy3.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::HEAVY));
        QCOMPARE(catHeavy1.toQString(), "H");

        QVERIFY(catSuper1.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::SUPER));
        QVERIFY(catSuper2.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::SUPER));
        QVERIFY(catSuper3.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::SUPER));
        QCOMPARE(catSuper1.toQString(), "J");

        QVERIFY(catUnknown1.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::UNKNOWN));
        QVERIFY(catUnknown1.isUnknown());
        QVERIFY(catUnknown2.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::UNKNOWN));
        QVERIFY(catUnknown2.isUnknown());
        QVERIFY(catUnknown3.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::UNKNOWN));
        QVERIFY(catUnknown3.isUnknown());
        QVERIFY(catUnknown4.isCategory(swift::misc::aviation::CWakeTurbulenceCategory::UNKNOWN));
