...
namespace BlackMiscTest
{
    ...
    void CTestVectorMatrix::vectorBasics()
    {
        ...
        QVERIFY2(CMath::epsilonEqual(v6.dotProduct(v7), 26), "Dot product is wrong, 26 expected");
        QVERIFY2(CMath::epsilonEqual(v6.length(), sqrt(1.0 + 4.0 + 9.0)), "Wrong vector magnitude");
    }
